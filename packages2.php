...
<!---images-hover-effects--->
				...
				<div class="find-place dfind-place">
					<div class="wrap">
						...
						<div class="p-ww">
							<form>
								<span> Where</span>
								<input class="dest" id="myInput" type="text" Placeholder="Distination">
							<!--	<span> When</span>
 ...
 if(isset($_POST['search']))
			...
			try {
				$dest=$_POST['dest'];
				$dest="%".$dest."%";
    $sql ="SELECT * FROM package where package_name LIKE  ? or package_desc LIKE  ?";
    $query= $conn -> prepare($sql);
	$query->bindParam(1,$dest,PDO::PARAM_STR);	
	$query->bindParam(2,$dest,PDO::PARAM_STR);
    $query-> execute();
