...
?>
   <!--main content start-->
		...
		if(isset($_FILES['pimage']))
	{
			...
			if(!empty($name))
			{
				if(in_array($ext,$compare))
				{
					...
					if(move_uploaded_file($tmp_name,$location.$name))
					{
						...
						$sql="INSERT INTO package(package_name,package_desc,start_from,img_path,facility_highlight) VALUES(?,?,?,?,?)"; 
		...
		if($lastInsertId)
		{
			echo '<script> alert("Package details has been Added");</script>';
			    echo "<script > document.location = 'managepackage.php'; </script>";
...
try {
 ...
 ?>
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class=" form-control" id="pdesc" name="pdesc" type="text" required/>
                      </div>
                    </div>
					<div class="form-group ">
