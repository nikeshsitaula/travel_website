	...
	if ($row = $query->fetch(PDO::FETCH_ASSOC))
{
		...
		unlink($imgpath);
		$sql2="DELETE FROM offers WHERE id=?"; 
		...
		{
			echo '<script>
                                alert("Special Offer Detail Deleted Successfully.");
	...
	while ($row = $query->fetch(PDO::FETCH_ASSOC))
{
	?>
     ...
     <td><img src="<?php echo $row['img_path']; ?>" width="100px"/></td>                                                
               ...
               <td>
												   <div class="btn-group">
												  <a class="btn btn-success white" href="editoffer.php?pid=<?php echo $row['id'] ?>">Edit</a>
                        <a class="btn btn-danger white" onclick="return confirm('Are you sure you want to delete this offer detail?');" href="manageoffers.php?pid=<?php echo $row['id'] ?>">Delete</a>
						</div>
						</td>                                   
                                              </tr>
