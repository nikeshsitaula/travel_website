...
?>
   <!--main content start-->
		...
		if(isset($_FILES['pimage']))
	{
			...
			if(!empty($name))
			{
				if(in_array($ext,$compare))
				{
					...
					if(move_uploaded_file($tmp_name,$location.$name))
					{
						...
						$sql="INSERT INTO offers(name,img_path,facility_highlight) VALUES(?,?,?)"; 
		...
		if($lastInsertId)
		{
			echo '<script> alert("Special Offer details has been Added");</script>';
...
try {
 ...
 ?>
					...
					<div class="form-group ">
                      <label for="facilities" class="control-label col-lg-2">Highlight<span class="required">*</span></label>
                      <div class="col-lg-10">
